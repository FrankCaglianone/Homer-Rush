...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname HOMER-BROS) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
;;--------------------------------------------------- LIBRARIES --------------------------------------------------------------------------
(require 2htdp/image)
...
; Input/Output
; map? : number -> AppState
; takes a number and returns the respective AppState
...
; it checks if you are in the menu page 
...
; it checks if you are on the loading page
...
;; Input/Output
; check-vspeed : Stucture Boolean Number Boolean --> Number
; ======================================================================================
...
;--------- SET JUMPING SPEED ---------
;; Input/Output
; homer-jump : Structure Number -> Number
; it outputs ==================================================================
...
;--------- SET FALLING SPEED ---------
;; Input/Output
; homer-fall : Structure Number -> Number
; ==================================
...
;; Input/Output
; check-height : Number Scene -> Number
...
;--------- CHECK IF WALL ---------
; Input/Output
; wall? : Number Number Ground -> Number
...
;--------- CHECK IF MOVING ---------
; Input/Output
; check-speed : Number Number Number Ground -> AppState
...
;(check-expect (check-speed 1 0 0 0) )
...
;; Input/Output 
; check-start : AppState Boolean Boolean Boolean Number Back Number Boolean Boolean Number Boolean Boolean Boolean -> AppState
...
; Input/Output
; check-jstart : AppState Boolean Number -> AppState
...
;--------- BUILDING APPSTATE ---------
;; Input/Output
; construct : AppState Boolean Boolean Boolean Number Back Number Boolean Boolean Number Boolean Boolean Boolean -> AppState
; it return the game itself
...
(define (tock world)
  (cond
    ...
    [(< (back-pos (world-map world)) -6000)              ;homer has reaced the end 
     (construct world #false #true #false (posn-x (scene-pos-init (map? 6)))
                (back-scene (world-map world)) 0 #false #false 0 #false #true #false)]
