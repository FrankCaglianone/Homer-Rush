...
; the structure scene with the image, floors, pos-init, time
(define MAP2 (make-scene (scale 5 (bitmap "MAP2.png")) FLOORS_2 (make-posn 5908 INITIAL-HEIGHT) 120))
...
; the structure scene with the image, floors, pos-init, time
(define MAP3 (make-scene (scale 5 (bitmap "MAP3.png")) FLOORS_3 (make-posn 6484 INITIAL-HEIGHT) 150))
...
(define victory (make-scene (scale 3 (bitmap "victory.jpg")) 0 (make-posn 500 0) 0))
